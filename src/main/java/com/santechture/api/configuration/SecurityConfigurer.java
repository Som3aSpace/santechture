...
public class SecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    private String[] allowed = {"/admin/authenticate","/admin/register","/admin/list"};

    public SecurityConfigurer(MyUserDetailsService myUserDetailsService, JwtFilter jwtRequestFilter) {
